        ...
        Column {
            ...
            Flow {
                ...
                Repeater {
                    ...
                    delegate: BackgroundItem {
                        ...
                        onClicked: Zoo.addHabit(modelData.name, modelData.target)
            ...
            Row {
                ...
                TextField {
                    ...
                    EnterKey.onClicked: { if (text.trim().length) { Zoo.addHabit(text, parent.t); text = ""; parent.t = 1 } }
                }
                ...
                IconButton { id: habAdd; anchors.verticalCenter: habitField.verticalCenter
                             ...
                             onClicked: { if (habitField.text.trim().length) { Zoo.addHabit(habitField.text, parent.t); habitField.text = ""; parent.t = 1 } } }
            }
            Label {
